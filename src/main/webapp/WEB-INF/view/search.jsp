...
<body>
    ...
    <div class="left-container">
        <form class="form-inline" method="post" action="/usersByName">
            <input id="name" name="name" class="form-control mr-sm-2" type="text" placeholder="Search users by name">
    ...
    <div class="left-container">
        <form class="form-inline" method="post" action="/usersByMail">
            <input id="email" name="email" class="form-control mr-sm-2" type="text" placeholder="Search user by email">
